...
module.exports = {
    ...
    while (hasNextPage) {
        ...
        if (resp && resp.meta && resp.meta.result_count && resp.meta.result_count > 0) {
            ...
            if (resp.data) {
                userTweets.push.apply(userTweets, resp.data.slice( 1));
            }
    ...
    await interaction.channel.send({content: `Got ${userTweets.length} Tweets from ${userName} (user ID ${userId})! `, ephemeral: true});
