...
module.exports = {
    ...
    if (hasNextPage) {
        ...
        if (resp && resp.meta && resp.meta.result_count && resp.meta.result_count > 0) {
            ...
            if (resp.data) {
                let sumTweets = userTweets.push.apply(userTweets, resp.data)
                console.log(resp.includes.users[0].id, "resp")
                console.log(sumTweets, 'sumtweet')
        ...
        const url2 = `https://twitter.com/${userName}`
        console.log(url2)
    }
